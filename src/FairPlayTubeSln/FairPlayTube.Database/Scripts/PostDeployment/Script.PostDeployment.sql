...
--START OF USER REQUEST TYPES
DECLARE @USERREQUESTTYPENAME NVARCHAR(50) = 'FeatureRequest'
IF NOT EXISTS (SELECT * FROM [dbo].[UserRequestType] WHERE [Name] = @USERREQUESTTYPENAME)
BEGIN
    INSERT INTO UserRequestType([UserRequestTypeId],[Name]) VALUES ('1', @USERREQUESTTYPENAME)
END
SET @USERREQUESTTYPENAME = 'ContentRequest'
IF NOT EXISTS (SELECT * FROM [dbo].[UserRequestType] WHERE [Name] = @USERREQUESTTYPENAME)
BEGIN
